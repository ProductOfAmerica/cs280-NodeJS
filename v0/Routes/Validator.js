...
Validator.Tags = {
    ...
    oldPwdMismatch: "oldPwdMismatch",// Old password that was provided is incorrect.
    dupName: "dupName",              // Name duplicates an existing name, e.g. for login name
    dupChl: "dupChl",                // Attempt to sign up for Chl already signed up for.
